...
// Toggle CMS form vs inquiries panel
...
function populateForm(data) {
  ...
  document.getElementById('contacthelpImage').value = '';
  document.getElementById('contacthelpBgImage').value = '';
  document.getElementById('ContactCard1Icon').value = '';
  document.getElementById('ContactCard2Icon').value = '';
  for (let i = 0; i < 4; i++) {
...
document.getElementById('tokenHeroTitle').value = data.tokenHeroTitle || '';
  ...
  // 5. Contact Us Inputs
    ...
    document.getElementById('contactGlobalBadge').value = data.contactGlobalBadge || '';
    document.getElementById('contactGlobalTitle').value = data.contactGlobalTitle || '';
    renderContactGlobalParagraphsEditor(data.contactGlobalParagraphs || []);

    document.getElementById('contacthelpTitle').value = data.contacthelpTitle || '';
    setImagePreview('contacthelpImage-preview', data.contacthelpImage);
    setImagePreview('contacthelpBgImage-preview', data.contacthelpBgImage);
    document.getElementById('remove_contacthelpImage').value = 'false';
    document.getElementById('remove_contacthelpBgImage').value = 'false';
    document.getElementById('remove_ContactCard1Icon').value = 'false';
    document.getElementById('remove_ContactCard2Icon').value = 'false';
    document.getElementById('contacthelpImage').value = '';
    document.getElementById('contacthelpBgImage').value = '';
    document.getElementById('ContactCard1Icon').value = '';
    document.getElementById('ContactCard2Icon').value = '';
    rendercontacthelpParagraphsEditor(normalizeParagraphs(data.contacthelpParagraphs));

    document.getElementById('ContactCard1Title').value = data.ContactCard1Title || '';
    document.getElementById('ContactCard1Desc').value = data.ContactCard1Desc || '';
    document.getElementById('ContactCard1Email').value = data.ContactCard1Email || '';
    setImagePreview('ContactCard1Icon-preview', data.ContactCard1Icon);

    document.getElementById('ContactCard2Title').value = data.ContactCard2Title || '';
    document.getElementById('ContactCard2Desc').value = data.ContactCard2Desc || '';
    document.getElementById('ContactCard2Email').value = data.ContactCard2Email || '';
    setImagePreview('ContactCard2Icon-preview', data.ContactCard2Icon);
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  document.getElementById('inquiry-modal-delete')?.addEventListener('click', () => {
    if (activeInquiryId) deleteInquiryById(activeInquiryId);
  });
});
...
window.deleteInquiryById = deleteInquiryById;
